...
%% Plant Description
% It is a exponential increasing system of a Population Growth 
% Equation- dN(t)/dt=kN(t)
% N=Population a time t, k=constant, t=time
% Values- k=0.14, A=200
...
%% Math Analysis
% Independent: Time(t)
% Dependent: Population(N)
% Constant:  Constant(A)

%% Comparison Analysis
% 1) System without controller behaves exactly like an exponential Growth.
%    with the system growing exponentially.
